...
public class CustomButton extends Button {
    ...
    private void init(final Context context, final AttributeSet attrs){
        ...
        mPressedColor = typedArray.getColor(R.styleable.CustomButton_pressed_color,
                getResources().getColor(R.color.pressed_color_s));
        mUnPressedColor = typedArray.getColor(R.styleable.CustomButton_unpressed_color,
                getResources().getColor(R.color.unpressed_color_s));
        ...
        /*mBtnRadius = typedArray.getDimensionPixelSize(R.styleable.CustomButton_btn_radius,getResources().getDimensionPixelSize(R.dimen.btn_radius));*/
        typedArray.recycle();
        mPaint = new Paint();
        ...
        this.setBackgroundColor(getResources().getColor(R.color.transparent_s));
        mRectF = new RectF();
    }
